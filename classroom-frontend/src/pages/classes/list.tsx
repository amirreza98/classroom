...
const ClassesList = () => {
    ...
    const classColumns = useMemo<ColumnDef<ClassDetails>[]>(() => [
        {
            ...
            cell: ({ getValue }) => (
                <div className="flex items-center justify-center ml-2">
                    <img src={getValue<string>() || '/placeholder-class.png'} alt="Class Banner" className="w-10 h-10 rounded object-cover" />
                </div>
            )
        },
        {
        ...
        },
        {
            ...
            cell: ({ getValue }) => {
                ...
                return <Badge variant={status === 'active' ? 'default' : 'secondary'}>{status.charAt(0).toUpperCase() + status.slice(1)}</Badge>;
            }
        },
        {
            id: 'subject',
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="flex gap-1">
                    ...
                    <DeleteButton resource="classes" recordItemId={row.original.id} variant="outline" size="sm" />
                </div>
            )
        }
    ], []);
    ...
    const classTable = useTable<ClassDetails>({
        ...
        refineCoreProps: {
            ...
            filters: { permanent: [...subjectFilters, ...teacherFilters, ...searchFilters] },
